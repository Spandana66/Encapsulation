...
public class Sign_log_inpojo 
{
	...
	public static void main(String[] args) 
	{
		...
		Userpojo u1=new Userpojo(uname, uage, umb_no,u_alt_mob_no, umail_id, alt_mail_id, upwd);
	...
	////------------------------edit profile----------------------------------------------------------------------------------
	public static void editprofile(Userpojo u1) 
	{
	...
	//-----------------------------------------------------------------------------------------------
	//------------------------------show profile--------------------------------------------
	public static void profile(Userpojo u1) 
	{
